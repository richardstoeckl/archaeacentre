# Getting help with `archaeacentre`

Thank you for using `archaeacentre`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/archaeacentre`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/archaeacentre),
...
[search issues and pull requests](https://github.com/richardstoeckl/archaeacentre/issues)
